...
fun Greeting2(modifier: Modifier = Modifier) {
    Column(modifier.fillMaxSize().verticalScroll(rememberScrollState()), horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        intentButton("Bottom sheet", com.yogesh.composelearn.bottom_sheet.MainActivity::class.java,LocalContext.current)
        intentButton("LazyColumn item animation", com.yogesh.composelearn.lazycolumn_item_animation.MainActivity::class.java,LocalContext.current)
        intentButton("Parallax image scroll", com.yogesh.composelearn.parallax_image_list.MainActivity::class.java,LocalContext.current)
